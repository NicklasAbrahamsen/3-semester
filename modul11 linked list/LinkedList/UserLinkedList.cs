...
/*/
Koden er en metode, der fjerner den første node i en linked list, der forventer at indeholde User objekter, 
og returnerer det fjernede User objekt.
...
"removedData", som er User objektet i den fjernede node.
/*/
        public User RemoveFirst()
    {
        ...
        User removedData = first.Data;
        first = first.Next;
        return removedData;
    }

/*/
Koden er en metode, der fjerner en bestemt node, der indeholder et bestemt User objekt, fra en linked list.
Metoden tager et User objekt som argument og finder den tilsvarende node i listen ved at sammenligne objekternes 
"Name" properties.
...
af løkken, tjekker metoden om "node.Data.Name" er lig med "user.Name". Hvis de er ens, så sætter den "found" 
...
/*/
Koden er en metode, der henter den sidste node i en linked list, som forventer at indeholde User objekter.
...
Når loopet er færdig, så returneres "current.Data", som er User objektet i den sidste node i listen, som er 
